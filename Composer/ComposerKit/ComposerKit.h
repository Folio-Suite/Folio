...
//! Project version number for ComposerKit.
FOUNDATION_EXPORT double ComposerKitVersionNumber;

//! Project version string for ComposerKit.
FOUNDATION_EXPORT const unsigned char ComposerKitVersionString[];

...
- (void)connectToolbar:(FWEditorWindowController *)controller {
    ...
    [self.emphasisButton setAccessibilityLabel:NSLocalizedStringWithDefaultValue(@"formatting.emphasis", @"Localizable", [NSBundle bundleWithIdentifier:@"dev.foliosuite.WriteKit"], @"Emphasis", @"Accessibility label for semantic emphasis, distinct from visual Italic.")];
    [self.strongButton setAccessibilityLabel:NSLocalizedStringWithDefaultValue(@"formatting.strong-emphasis", @"Localizable", [NSBundle bundleWithIdentifier:@"dev.foliosuite.WriteKit"], @"Strong Emphasis", @"Accessibility label for strong semantic emphasis, distinct from visual Bold.")];
...
- (void)toggleEmphasis:(id)sender { [self toggleKey:FWEmphasis value:FKTextEmphasisEmphasis name:NSLocalizedStringWithDefaultValue(@"formatting.emphasis.undo", @"Localizable", [NSBundle bundleWithIdentifier:@"dev.foliosuite.WriteKit"], @"Emphasis", @"Undo action name for applying semantic emphasis, distinct from visual Italic. AppKit adds Undo or Redo.")]; }
- (void)toggleStrongEmphasis:(id)sender { [self toggleKey:FWEmphasis value:FKTextEmphasisStrongEmphasis name:NSLocalizedStringWithDefaultValue(@"formatting.strong-emphasis.undo", @"Localizable", [NSBundle bundleWithIdentifier:@"dev.foliosuite.WriteKit"], @"Strong Emphasis", @"Undo action name for applying strong semantic emphasis, distinct from visual Bold. AppKit adds Undo or Redo.")]; }

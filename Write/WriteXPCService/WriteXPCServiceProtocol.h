...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     _connectionToService = [[NSXPCConnection alloc] initWithServiceName:@"dev.foliosuite.WriteXPCService"];
     _connectionToService.remoteObjectInterface = [NSXPCInterface interfaceWithProtocol:@protocol(WriteXPCServiceProtocol)];

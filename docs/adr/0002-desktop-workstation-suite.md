...
Desktop capability and integration take precedence over cross-device feature parity or browser-style interface constraints. Companion applications may support focused workflows on other devices, but they do not define the functional ceiling of the suite.
